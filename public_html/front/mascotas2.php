...
?>
      ...
      <div class="card <?= $brr4 ?> card-outline">
        ...
        <div class="card-body">
          ...
          <div class="card-body p-0">        
            ...
            <?php if(v4lID44x50("200-002", $usuario_id) == TRUE){ /// --- AGREGAR mascotas ?>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th><?= lbl_t4bN0m8r3 ?></th>
                  <?php if(v4lID44x50("200-003", $usuario_id) == TRUE){ /// --- EDITAR mascota ?>
                ...
                <?php
                  ...
                  //foreach ($LU as $key => $u5h34r5) { ?>
                      <tr>
                        ...
                        <td><?= $u5h34r5['xunc'] ?></td>
                        <td><?= $u5h34r5['xuus'] ?></td>
                        <?php if(v4lID44x50("500-003", $usuario_id) == TRUE){ /// --- EDITAR mascota ?>
                          <td>
    ...
    <?php } ?>
      ...
      <!-- /.card -->
    <?php if(v4lID44x50("200-002", $usuario_id) == TRUE){ /// --- AGREGAR USUARIOS ?>
