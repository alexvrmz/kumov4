<?php
include('idiomas/'.$iDi['u5h8ir5_iDi'].'/i_Tm0d3ls-3di7.php');
    ...
    <!-- Main content -->
      ...
      <div class="card <?= $brr4 ?> card-outline col-lg-6">
        ...
        <div class="card-body">
          ...
          <form name="edit_user" method="post" action="ApiPHP/Tm0d3ls_4pi.php?accion=Tm0d3ls_9i45" enctype="multipart/form-data">
