            ...
            <table>
            	<tr>
            		<td>
                      ...
                      https://mieke.mx/acceso?accion=x007&xcd={{r001x2}}&cft={{FRGF}}<br></h3>
            				<p><a href="https://mieke.mx/acceso?accion=x007&xcd={{r001x2}}&cft={{FRGF}}" class="btn btn-primary">Activar Mi Cuenta</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
