...
! function(e, t) {
  ...
  var A = "SidebarSearch",
      ...
      B = function() {
          ...
          return a.init = function() {
              var e = this;
              0 != i.default(N).length && (0 == i.default(N).next(".sidebar-search-results").length && i.default(N).after(i.default("<div />", {
                  class: "sidebar-search-results"
              })), 0 == i.default(".sidebar-search-results").children(".list-group").length && i.default(".sidebar-search-results").append(i.default("<div />", {
                  class: "list-group"
              })), this._addNotFound(), i.default(".main-sidebar .nav-sidebar").children().each((function(t, a) {
                  e._parseItem(a)
              })))
          }, a.search = function() {
              var e = this,
  ...
  }, e.CardRefresh = l, e.CardWidget = f, e.ControlSidebar = p, e.DirectChat = v, e.Dropdown = w, e.ExpandableTable = j, e.Fullscreen = z, e.Layout = L, e.PushMenu = D, e.SidebarSearch = B, e.Toasts = J, e.TodoList = Y, e.Treeview = te, Object.defineProperty(e, "__esModule", {
      value: !0
  })
}));
